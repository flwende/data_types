...
#if !defined(DATA_TYPES_MATH_HPP)
#define DATA_TYPES_MATH_HPP
...
namespace XXX_NAMESPACE
{
	...
	{                                                                                                           \
		return vec<T, 1>(detail::math<T>::FUNC(v.x));                                                           \
	}                                                                                                           \
																												\
	template <typename T>                                                                                       \
	inline vec<T, 1> FUNC(const IN_T<C T, 1>&& v)                                                               \
	...
	{                                                                                                           \
		return vec<T, 2>(detail::math<T>::FUNC(v.x), detail::math<T>::FUNC(v.y));                               \
	}                                                                                                           \
																												\
	template <typename T>                                                                                       \
	inline vec<T, 2> FUNC(const IN_T<C T, 2>&& v)                                                               \
	...
	{                                                                                                           \
		return vec<T, 3>(detail::math<T>::FUNC(v.x), detail::math<T>::FUNC(v.y), detail::math<T>::FUNC(v.z));   \
	}                                                                                                           \
																												\
	template <typename T>                                                                                       \
	inline vec<T, 3> FUNC(const IN_T<C T, 3>&& v)                                                               \
	...
	MACRO_C(sqrt, detail::proxy_vec)
	MACRO_C(log, detail::proxy_vec)
	MACRO_C(exp, detail::proxy_vec)
	...
	MACRO_C(*, vec, vec)
	MACRO_C(*, vec, detail::proxy_vec)
	MACRO_C(*, detail::proxy_vec, vec)
	MACRO_C(*, detail::proxy_vec, detail::proxy_vec)
