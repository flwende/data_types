...
namespace TUPLE_NAMESPACE
{
    namespace internal
    {
        ...
        public:
            ...
            using BasePointerType = typename std::conditional<is_homogeneous, ::XXX_NAMESPACE::memory::Pointer<T_1, T_2, T_3>, ::XXX_NAMESPACE::memory::MultiPointer<T_1, T_2, T_3>>::type;
