...
INC = -I$(HOME)/opt/gnu-7.2.0/boost/include -I$(GLIBC_DIR)/include -I./include -I./src/include -I/dassw/intel/compilers_and_libraries_2018.1.163/linux/compiler/include
