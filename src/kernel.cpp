...
using namespace fw;
        ...
        template <>
        template <>
        double kernel<element_type>::cross<1, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x_1, const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x_2, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<1>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::cross<2, 2>(const fw::buffer<element_type, 2, fw::data_layout::SoAi>& x_1, const fw::buffer<element_type, 2, fw::data_layout::SoAi>& x_2, fw::buffer<element_type, 2, fw::data_layout::SoAi>& y, const array_type<2>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::cross<3, 3>(const fw::buffer<element_type, 3, fw::data_layout::SoAi>& x_1, const fw::buffer<element_type, 3, fw::data_layout::SoAi>& x_2, fw::buffer<element_type, 3, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::cross<3, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x_1, const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x_2, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<1, 1>(fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, const array_type<1>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<2, 2>(fw::buffer<element_type, 2, fw::data_layout::SoAi>& x, const array_type<2>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<3, 3>(fw::buffer<element_type, 3, fw::data_layout::SoAi>& x, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<3, 1>(fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<1, 1>(fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, const array_type<1>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<2, 2>(fw::buffer<element_type, 2, fw::data_layout::SoAi>& x, const array_type<2>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<3, 3>(fw::buffer<element_type, 3, fw::data_layout::SoAi>& x, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<3, 1>(fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<1, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<1>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<2, 2>(const fw::buffer<element_type, 2, fw::data_layout::SoAi>& x, fw::buffer<element_type, 2, fw::data_layout::SoAi>& y, const array_type<2>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<3, 3>(const fw::buffer<element_type, 3, fw::data_layout::SoAi>& x, fw::buffer<element_type, 3, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::exp<3, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<1, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<1>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<2, 2>(const fw::buffer<element_type, 2, fw::data_layout::SoAi>& x, fw::buffer<element_type, 2, fw::data_layout::SoAi>& y, const array_type<2>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<3, 3>(const fw::buffer<element_type, 3, fw::data_layout::SoAi>& x, fw::buffer<element_type, 3, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
        ...
        template <>
        template <>
        double kernel<element_type>::log<3, 1>(const fw::buffer<element_type, 1, fw::data_layout::SoAi>& x, fw::buffer<element_type, 1, fw::data_layout::SoAi>& y, const array_type<3>& n)
        {
            double time = omp_get_wtime();
